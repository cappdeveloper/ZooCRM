...
class Leads extends AdminController
{
    ...
    public function get_lead_excel_export(){
       // print_r($this->input->post());die;
        $myData = $this->input->post();
     $path =  FCPATH.'uploads';
     // file name
        $filename = $path.'mydata_'.date('Ymd').'.csv';
        ...
        $header = array("Name","Email Address","Phone","Company","Address","City","State","Country","Zip Code","Status","Source","Assigned","Created","Last Contact");
        fputcsv($file, $header);
 
        
            fputcsv($file,array($myData['lname'],$myData['email'],$myData['phone'],$myData['company'],$myData['address'],$myData['city'],$myData['state'],$myData['country'],$myData['zip'],$myData['status_name'],$myData['source_name'],$myData['assigned'],$myData['dateadded'],$myData['lastcontact']));
